...
const CONFIG = {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=FJSVH2c4NnI",
    textos: {
        cat1: { t: "QUIÉNES SOMOS", c: "Nacimos con una sola misión: ¡resaltar tu belleza natural y hacerte lucir espectacular! Nos encanta consentirte en tus eventos especiales y momentos importantes con peinados profesionales, maquillaje impecable y un estilo único creado especialmente para ti." },
        cat2: { t: "ESTO NOS HACE DIFERENTES", c: "En nuestro estudio de belleza te ofrecemos un servicio de la más alta calidad con productos profesionales de marcas reconocidas, técnicas en tendencia y asesoría personalizada para garantizar que tu look luzca perfecto e intacto todo el día." },
        cat3: { t: "CLIENTES FELICES", c: "Nuestras clientas nos eligen y recomiendan por nuestra gran dedicación, puntualidad, excelente trato y resultados impecables, reconociendo nuestra experiencia y pasión en cada peinado y maquillaje para bodas, graduaciones y eventos sociales." }
    },
    sucursales: {
...
function renderGallery(cat) {
    ...
    if (cat === 'cat3' || cat === 'cat2') {
        ...
        if (cat === 'cat3') {
            ...
            videoContainer.innerHTML = `
                <a href="https://www.youtube.com/shorts/7NWN73CYBlY" target="_blank" style="background: #b00; color: #fff; padding: 12px 25px; border-radius: 12px; text-decoration: none; font-weight: 900; font-size: 0.9rem;">
